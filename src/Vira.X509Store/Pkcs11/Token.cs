...
public class Token : IDisposable
{
    ...
    //    get
    //    {
    //        _session ??= _tokenContext.AuthenticatedSession;

    //        //if (!SessionIsAuthenticated(_session))
    //        //if (_session.IsUserSession())
    //        //{
    //        //    try
    //        //    {
    //        //        if (PKCS11Library.Instance.TokenPin != null)
    //        //        {
    //        //            _tokenContext.AuthenticatedSession?.Login(CKU.CKU_USER, PKCS11Library.Instance.TokenPin.ToBString());
    //        //        }
    //        //        else
    //        //        {
    //        //            var pinResult = PKCS11Library.Instance.RequestTokenPinAsync();
    //        //            //var pin = PinProviderUtils.GetTokenPin(_tokenContext);
    ...
    //    {
    //        CKS.CKS_RO_PUBLIC_SESSION or CKS.CKS_RW_PUBLIC_SESSION => false,
    //        CKS.CKS_RO_USER_FUNCTIONS or CKS.CKS_RW_USER_FUNCTIONS or CKS.CKS_RW_SO_FUNCTIONS => true,
