...
namespace Org.BouncyCastle.Asn1
{
        ...
        : Asn1Object, IEnumerable
    {
        ...
        public static Asn1Set GetInstance(object obj)
        {
            ...
            if (obj is Asn1SetParser parser)
                return GetInstance(parser.ToAsn1Object());

            if (obj is byte[] array)
            {
                try
                {
                    return GetInstance(FromByteArray(array));
                }
                catch (IOException e)
                {
            ...
            if (obj is Asn1Encodable encodable)
            {
                if (encodable.ToAsn1Object() is Asn1Set primitive)
                    return primitive;
            }
...
//					return asn1OctetString.Parser;
        ...
        {
            if (!(asn1Object is Asn1Set other))
                return false;
