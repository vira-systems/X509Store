...
namespace Org.BouncyCastle.Crypto
{
	internal class XofFactory<TParams>: IXofFactory<TParams>
	{
		...
		private readonly IParameterizedEngineProvider<IXof, TParams> xofProvider;

		internal XofFactory(TParams parameters, IParameterizedEngineProvider<IXof, TParams> xofProvider)
		{
		...
		public IVariableStreamCalculator<IBlockResult> CreateCalculator()
		{
            ...
            return new XofCalculator(xofProvider.CreateEngine(EngineUsage.GENERAL, parameters));
		}
	}
}
