...
{
    public interface IPrivateKeyDHService : IKeyUnwrappingService, IAgreementCalculatorService
    {
        ...
        : AsymmetricDHKey, IAsymmetricPrivateKey, ICryptoServiceType<IPrivateKeyDHService>, IServiceProvider<IPrivateKeyDHService>
    {
        ...
        private class PrivateKeyDHService : IPrivateKeyDHService
        {
            ...
            public IAgreementCalculator<A> CreateAgreementCalculator<A>(A algorithmDetails) where A : IParameters<Algorithm>
            {
                ...
                return (IAgreementCalculator<A>)new FipsDH.AgreementCalculator(algorithmDetails as FipsDH.AgreementParameters, privateKey);
            }
