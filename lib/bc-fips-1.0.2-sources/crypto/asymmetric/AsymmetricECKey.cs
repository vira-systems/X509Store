...
namespace Org.BouncyCastle.Crypto.Asymmetric
{
        ...
        : IAsymmetricKey
	{
		...
		internal AsymmetricECKey(Algorithm algorithm, IECDomainParametersID domainParameterID)
            : this(algorithm, ECDomainParametersIndex.LookupDomainParameters(domainParameterID))
		{
		}

		internal AsymmetricECKey(Algorithm algorithm, AlgorithmIdentifier algorithmIdentifier)
		...
		{
            get { return CheckAccess().domainParameters; }
		}
		...
		private AsymmetricECKey CheckAccess()
		{
